    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('celular_recado', models.CharField(blank=True, max_length=20, null=True, verbose_name='Recado')),
                ...
                ('parentesco_do_responsavel', models.CharField(blank=True, choices=[('F', 'Filho'), ('N', 'Neto'), ('I', 'Irmão'), ('O', 'Outro')], max_length=1, null=True, verbose_name='Parentesco do Responsável')),
