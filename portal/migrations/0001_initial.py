    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('1', 'Ativo'), ('2', 'Inativo')], max_length=1, verbose_name='Estatus')),
                ('tipo_usuario', models.CharField(choices=[('1', 'Administrador'), ('2', 'Responsável'), ('3', 'Cuidador'), ('4', 'Dependente'), ('5', 'Técnico em Enfermagem')], max_length=1, verbose_name='Tipo de Usuário')),
            ],
        ),
        migrations.CreateModel(
            name='Responsavel',
